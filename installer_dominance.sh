...
function display_menu() {
    ...
    ${C_PURPLE}╠═══════════════════════════════════════════════════════╣${C_RESET}
    ${C_PURPLE}║${C_RESET}  ${C_BOLD}--- 本猫猫的指令清单 ---${C_RESET}                             ${C_PURPLE}║${C_RESET}
    ${C_PURPLE}║${C_RESET}  ${C_GREEN}[1]${C_RESET} ⚡ 召唤酒馆         ${C_RESET}(启动 SillyTavern)           ${C_PURPLE}║${C_RESET}
    ${C_PURPLE}║${C_RESET}  ${C_GREEN}[2]${C_RESET} ✨ 为酒馆注入新魔力 ${C_RESET}(更新 SillyTavern)           ${C_PURPLE}║${C_RESET}
    ${C_PURPLE}║${C_RESET}  ${C_GREEN}[3]${C_RESET} 🔮 强化魔法契约     ${C_RESET}(更新本契约)                 ${C_PURPLE}║${C_RESET}
    ${C_PURPLE}║${C_RESET}  ${C_YELLOW}[4]${C_RESET} 💥 ${C_BOLD}【毁灭与新生】${C_RESET}   ${C_YELLOW}(重装酒馆，数据将丢失！)${C_RESET}     ${C_PURPLE}║${C_RESET}
    ${C_PURPLE}║${C_RESET}  ${C_CYAN}[5]${C_RESET} 🔧 施展${C_PURPLE}【法则修复术】${C_RESET}(修复网络连接问题)          ${C_PURPLE}║${C_RESET}
    ${C_PURPLE}║${C_RESET}                                                       ${C_PURPLE}║${C_RESET}
    ${C_PURPLE}║${C_RESET}  ${C_RED}[9]${C_RESET} 💔 背叛契约         ${C_RESET}(卸载并抹除一切)             ${C_PURPLE}║${C_RESET}
    ${C_PURPLE}║${C_RESET}  ${C_BLUE}[0]${C_RESET} 👋 退下             ${C_RESET}(退出，可用 'miao' 再次召唤) ${C_PURPLE}║${C_RESET}
    ${C_PURPLE}╚═══════════════════════════════════════════════════════╝${C_RESET}
